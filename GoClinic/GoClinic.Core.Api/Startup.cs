...
using Goclinic.Agendamento.Core.Data.Repository;
         ...
         /*   services.AddMvc(config =>
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Autorização por JWT usando o esquema Bearer. \r\n\r\n Enter 'Bearer' [espaço] e cole seu token fornecido no login.\r\n\r\nExemplo: \"Bearer 12345abcdef\"",
                });
